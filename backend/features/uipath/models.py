...
class Server(models.Model):
    ...
    loginUrl: str = models.CharField(max_length=500)
    releasesUrl: str = models.CharField(max_length=500)
    startJobUrl: str = models.CharField(max_length=500)
    getJobsUrl: str = models.CharField(max_length=500)
    ...
    uiPathFilePath: str = models.CharField(max_length=500)
...
class Trigger(models.Model):
    ...
    releaseKey: str = models.CharField(max_length=360)
    processName: str = models.CharField(max_length=60)
    tenancyName: str = models.CharField(max_length=60)
...
class Execution(models.Model):
    ...
    startJobKey: str = models.CharField(max_length=360)
    ...
    def add_process_inputs(self, baseUrl=None):
        self.processInputs.add(*self.trigger.processInputs.all())
        self.save()
